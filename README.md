...
Requires [requests[security]](https://pypi.python.org/pypi/requests), [beautifulsoup4](https://pypi.python.org/pypi/beautifulsoup4/4.3.2), and [lxml](https://pypi.python.org/pypi/lxml/3.4.1).
...
Because `ratebeer.py` does not use an API, since one is not provided, no key is required. Simply:
...
**Contributors**:
  * Vincent Castellano (@[Surye](https://github.com/Surye)) - Python 2 and 3 compatability
